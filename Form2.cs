...
namespace win1
{
    public partial class Form1 : Form
    {
        ...
        private void Prepare()
        {
            ...
            string[] spearator = {" ", "\n"};
            var count = 100000000;
            Global.strlist = str.Split(spearator, count, StringSplitOptions.RemoveEmptyEntries); 

            string[] spearator2 = {"\n"};
            var count_2 = 100000000;
           
            Global.strlist_2 = str.Split(spearator2, count_2, StringSplitOptions.RemoveEmptyEntries); 
            ...
            while (w < Global.strlist_2.Length && Global.step_flag == 1)
                if (Global.step_flag == 1)
                {
                    ...
                    var ins = Global.strlist_2[w]
                        .Split(spearator_3, count_3, StringSplitOptions.RemoveEmptyEntries); 
                    if (ins[0] == "ORG")
                    {
                    ...
                    else if (Global.hlt_flag == 0)
                    {
                        ...
                        var lbl = Global.strlist_2[w]
                            .Split(spearator_4, count_4, StringSplitOptions.RemoveEmptyEntries); 
 ...
 Please write again", "Warning!");
        ...
        private void Compile_Click(object sender, EventArgs e)
        {
            ...
            string[] spearator = {" ", "\n"};
            var count = 100000000;
            var strlist = str.Split(spearator, count, StringSplitOptions.RemoveEmptyEntries); 
            ...
            var strlist_2 = str.Split(spearator_2, count_2, StringSplitOptions.RemoveEmptyEntries);
            int flag = 0, emp = 0;
            for (var i = 0; i < strlist_2.Length; i++)
            {
                ...
                if (strlist_2[i].IndexOf(',') > -1)
                {
                    ...
                    if (org_int > 0)
                        Global.LABEL.Add(strlist_l[0], (org_int + i - 1).ToString("X")); 
                    else
                        Global.LABEL.Add(strlist_l[0], i.ToString("X")); 
                    ...
                    if (strlist_g.Length > 2)
                    {
                        ...
                        {
                            hexval = strlist_g[2];
                            Global.VALUE.Add(strlist_l[0], hexval); 
                        }
                        ...
                        if (org_int > 0)
                            Global.ADDRESS.Add((org_int + i - 1).ToString("X"), hexval); 
                        else
                            Global.ADDRESS.Add(i.ToString("X"), hexval); 
                    }
                ...
                if (strlist_g[0] == "DEC")
                {
                    ...
                    if (org_int > 0 && flag == 0)
                        Global.ADDRESS.Add((org_int + i - 1).ToString("X"), hexadecimal);
                    else if (org_int == 0 && flag == 0)
                        Global.ADDRESS.Add(i.ToString("X"), hexadecimal); 
                    else if (org_int > 0 && flag == 1)
                        Global.ADDRESS.Add((org_int + i - 1 - emp).ToString("X"), hexadecimal); 
                }

                if (strlist_g[0] == "HEX")
                {
                    if (org_int > 0)
                        Global.ADDRESS.Add((org_int + i - 1).ToString("X"), strlist_g[1]); 
                    else
        ...
        private void SHOW_VARIABLE_ONRAM() 
        {
        ...
        private void opcode_Click(object sender, EventArgs e)
        {
